...
Phase 2C attendance preserves occurrence-time academic session/class and roster context rather than deriving history from a mutable current class. It has no term/calendar subsystem dependency. Corrections preserve immutable superseded evidence, and every write retains authenticated identity attribution with an optional explicit staff link. Implemented and verified on 2026-08-31.
